            ...
            //Value
            {
                ...
                "<div style='font-size:16px;padding:10px 18px;margin:2px 10px 0;background-color:rgba(0,0,0,0.1);border-radius:10px;'>";
                    ...
                    //String
                        ...
                        "'<span style='white-space:pre'>".($mixed===""?'""':$mixed)."</span>'";
                                ...
                                if(isset($attributes))
                                    foreach ($attributes as $key => $row)
                                    {
                                        ...
                                        "<tr>".
                                            ...
                                            "<td>";
                                                //Phalcon
                                                if($key==='container' || $key==='modelsManager' || $key=='modelsMetaData')
                                                    print"PHALCON VAR ($key)";
                                                //Self Reference
                                                else if($GLOBALS['variable_debugger___starter_reference']!==null && $GLOBALS['variable_debugger___starter_reference']===$row['value'])
                                                    print"<div class='variable-debug' style='padding:10px;border:1px solid rgba(0,0,0,0.2);color:#A00;'><b>&SELF REFERENCE</b></div>";
                                                //Normal Value
                                                else
                                                    VD($row['value']);

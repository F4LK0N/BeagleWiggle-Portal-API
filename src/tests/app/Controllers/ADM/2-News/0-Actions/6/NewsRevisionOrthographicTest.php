...
class NewsRevisionOrthographicTest extends FknTestCase
{
    ...
    {
        App::RUN("/ADM/News/RevisionOrthographic/1");
        $result = App::RESULT();
    ...
    public function testInputInvalid()
    {
        ...
        App::RUN("/ADM/News/RevisionOrthographic/0");
        $result = App::RESULT();
